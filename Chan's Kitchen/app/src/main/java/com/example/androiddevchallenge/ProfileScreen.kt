...
@Composable
fun ProfileScreen(meal: Meal, onNavIconPressed: () -> Unit = { }) {
...
private fun ProfileContent(meal: Meal, containerHeight: Dp) {
    Column {
        ...
        ProfileProperty(stringResource(R.string.ingredients), meal.ingredients.toString())

        ProfileProperty(stringResource(R.string.instructions), meal.description)
...
@Composable
private fun Name(meal: Meal, modifier: Modifier = Modifier) {
    Text(
        text = meal.title,
        modifier = modifier,
        ...
        AnimatingFabContent(
            icon = {
                Icon(
                    ...
                    contentDescription = stringResource(R.string.call_me)
                )
            },
            text = {
                Text(
